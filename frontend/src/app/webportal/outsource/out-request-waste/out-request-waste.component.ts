...
@Component({
  selector: 'app-out-request-waste',
  templateUrl: './out-request-waste.component.html',
  styleUrls: ['./out-request-waste.component.scss']
})
export class OutRequestWasteComponent implements OnInit {
